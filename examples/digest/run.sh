...
#   1) подними Ollama и стяни модель (см. README.md):
#        ollama serve & ; ollama pull qwen2.5:3b
#   2) задай api-реквизиты в окружении:
#        export ANGARION_ACCOUNTS__MAIN__API_ID=...
#        export ANGARION_ACCOUNTS__MAIN__API_HASH=...
#   3) подставь id групп в app.toml.
#
...
# 5. запуск конвейера через лаунчер (он регистрирует кастомный процессор)
